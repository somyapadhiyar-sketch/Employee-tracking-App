  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`flex-1 overflow-x-hidden overflow-y-auto p-3 pt-8 sm:p-5 sm:pt-10 md:p-6 md:pt-12 lg:p-6 relative min-w-0 w-full transition-all duration-300 ${isSidebarOpen ? "lg:ml-72" : "lg:ml-0"
            }`}
          style={{ height: "100vh" }}
        >
